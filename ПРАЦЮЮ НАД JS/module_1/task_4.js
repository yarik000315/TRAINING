...
let shopingList = prompt("Сколько дроидов вы хотите купить?");
const transformationOfNumber = Number(shopingList);
let totalPrice;
let balanceCredits;
...
if (shopingList === null) {
  ...
  totalPrice = transformationOfNumber * pricePerDroid;
  if (totalPrice > credits) {
    console.log("Недостаточно средств на счету!");
  } else {
    balanceCredits = credits - totalPrice;
    console.log(
      `Вы купили ${transformationOfNumber} дроидов, на счету осталось ${balanceCredits} кредитов.`
    );
  }
}
